...
export const BOARD_TILES: BoardTile[] = [
  ...
  { position: 13, kind: 'PROPERTY', cardId: 'tong-lau-ki-lung-street' },
  ...
  { position: 29, kind: 'PROPERTY', cardId: 'transport-third-runway' },
  { position: 30, kind: 'PROPERTY', cardId: 'transport-high-speed-rail' },
  { position: 31, kind: 'PROPERTY', cardId: 'transport-tsing-ma-bridge' },
];
